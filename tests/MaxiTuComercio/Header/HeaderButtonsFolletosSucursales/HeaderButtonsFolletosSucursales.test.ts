...
test('@Regression @Header () Verificar que al clickear el boton Folletos del header en Folletos o Sucursal funciona correctamente', async ({headerHBFSFolletosButton}) => {
...
test('@Regression @Header () Verificar que al clickear el boton Sucursales del header en Folletos o Sucursal funciona correctamente', async ({headerHBFSSucursalesButton}) => {
...
test('@Regression @Header () Verificar que al clickear el boton Quiero Folleto del header en Folletos o Sucursal funciona correctamente', async ({headerHBFSQuieroFolletoButton}) => {
...
test('@Regression @Header () Verificar que al clickear el boton Quiero Terminal de Cobro del header en Folletos o Sucursal funciona correctamente', async ({headerHBFSQuieroTerminalCobroButton}) => {
...
test('@Regression @Header () Verificar que al clickear el boton Compra Online del header en Folletos o Sucursal funciona correctamente', async ({headerHBFSCompraOnlineButton}) => {
