...
// })
//
// test('@Smoke @Regression (B2B-TC-310) Verificar que al clickear en Menu Lacteos y Productos Frescos funciona correctamente', async ({menuHamburLacteosProdsFrescos}) => {
//
