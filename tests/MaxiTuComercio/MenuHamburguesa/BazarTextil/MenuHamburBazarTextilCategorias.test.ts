...
// })
//
// test('@Smoke @Regression (B2B-TC-359) Verificar que funciona correctamente al clickear en el Menu Bazar y Textil: VER TODO', async ({menuHamburBazarTextilVerTodo}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-360) Verificar que funciona correctamente al clickear en el Menu Bazar y Textil: Automotor', async ({menuHamburBazarTextilAutomotor}) => {
//
//     await test.step('Click en Automotor', async () => {
//         await menuHamburBazarTextilAutomotor.navigateToMenuHamburBazarTextilAutomotor()
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-361) Verificar que funciona correctamente al clickear en el Menu Bazar y Textil: Cocina y Comedor', async ({menuHamburBazarTextilCocinaComedor}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-362) Verificar que funciona correctamente al clickear en el Menu Bazar y Textil: Deco y Organizacion', async ({menuHamburBazarTextilDecoOrganizacion}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-363) Verificar que funciona correctamente al clickear en el Menu Bazar y Textil: Ferreteria y Pintura', async ({menuHamburBazarTextilFerreteriaPintura}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-364) Verificar que funciona correctamente al clickear en el Menu Bazar y Textil: Librerias', async ({menuHamburBazarTextilLibreria}) => {
//
