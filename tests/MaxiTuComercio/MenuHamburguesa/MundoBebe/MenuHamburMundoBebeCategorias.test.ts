...
// })
//
// test('@Smoke @Regression (B2B-TC-405) Verificar que funciona correctamente al clickear en el Menu Mundo Bebe: VER TODO', async ({menuHamburMundoBebeVerTodos}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-406) Verificar que funciona correctamente al clickear en el Menu Mundo Bebe: Alimento para Bebe', async ({menuHamburMundoBebeAlimentoBebe}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-407) Verificar que funciona correctamente al clickear en el Menu Mundo Bebe: Despues del Banio', async ({menuHamburMundoBebeDespuesBanio}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-408) Verificar que funciona correctamente al clickear en el Menu Mundo Bebe: Paniales', async ({menuHamburMundoBebePaniales}) => {
//
//     await test.step('Click en Paniales', async () => {
//         await menuHamburMundoBebePaniales.navigateToMenuHamburMundoBebePaniales()
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-409) Verificar que funciona correctamente al clickear en el Menu Mundo Bebe: Para el Banio', async ({menuHamburMundoBebeParaElBanio}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-410) Verificar que funciona correctamente al clickear en el Menu Mundo Bebe: Toallitas Humedas', async ({menuHamburMundoBebeToallitasHumedas}) => {
//
