...
test('@Smoke @Regression (B2B-TC-411) Verificar que funciona correctamente al clickear en el Menu Panaderia: VER TODO', async ({menuHamburPanaderiaVerTodos}) => {

    await test.step('Click en Panaderia VER TODO', async () => {
        await menuHamburPanaderiaVerTodos.navigateToMenuHamburPanaderiaVerTodos()
    })
})
test('@Regression @MenuHamburguesa (B2B-TC-412) Verificar que funciona correctamente al clickear en el Menu Panaderia: Pan Rallado y Rebozadores', async ({menuHamburPanaderiaPanRalladoRebozadores}) => {
...
test('@Regression @MenuHamburguesa (B2B-TC-413) Verificar que funciona correctamente al clickear en el Menu Panaderia: Panificados', async ({menuHamburPanaderiaPanificados}) => {
