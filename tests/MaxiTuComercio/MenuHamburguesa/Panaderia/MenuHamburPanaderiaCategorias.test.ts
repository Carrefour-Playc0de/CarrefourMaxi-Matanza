...
test('XYZQW @Smoke @Regression () Verificar que funciona correctamente al clickear en el Menu Panaderia: VER TODO', async ({menuHamburPanaderiaVerTodos}) => {

    await test.step('Click en Panaderia VER TODO', async () => {
        await menuHamburPanaderiaVerTodos.navigateToMenuHamburPanaderiaVerTodos()
    })
})
test('XYZQW @Regression @MenuHamburguesa () Verificar que funciona correctamente al clickear en el Menu Panaderia: Pan Rallado y Rebozadores', async ({menuHamburPanaderiaPanRalladoRebozadores}) => {
...
test('XYZQW @Regression @MenuHamburguesa () Verificar que funciona correctamente al clickear en el Menu Panaderia: Panificados', async ({menuHamburPanaderiaPanificados}) => {
