...
// })
//
// test('@Smoke @Regression (B2B-TC-385) Verificar que funciona correctamente al clickear en el Menu Lacteos y Productos Frescos: VER TODO', async ({menuHamburLacteosProdsFrescosVerTodo}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-386) Verificar que funciona correctamente al clickear en el Menu Lacteos y Productos Frescos: Dulce de Leche', async ({menuHamburLacteosProdsFrescosDulceDeLeche}) => {
//
...
//     })
// })
// test('Regression @MenuHamburguesa (B2B-TC-387) Verificar que funciona correctamente al clickear en el Menu Lacteos y Productos Frescos: Leches', async ({menuHamburLacteosProdsFrescosLeches}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-388) Verificar que funciona correctamente al clickear en el Menu Lacteos y Productos Frescos: Leches en Polvo y Larga Vida', async ({menuHamburLacteosProdsFrescosLechesPolvoYLargaVida}) => {
//
...
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-389) Verificar que funciona correctamente al clickear en el Menu Lacteos y Productos Frescos: P.A.S.', async ({menuHamburLacteosProdsFrescosPAS}) => {
//
//     await test.step('Click en P.A.S.', async () => {
//         await menuHamburLacteosProdsFrescosPAS.navigateToMenuHamburLacteosProdsFrescosPAS()
//     })
// })
// test('@Regression @MenuHamburguesa (B2B-TC-390) Verificar que funciona correctamente al clickear en el Menu Lacteos y Productos Frescos: Quesos', async ({menuHamburLacteosProdsFrescosQuesos}) => {
//
